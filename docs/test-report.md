...
| Unit + integration | `npm test` | ✅ 134/134 pass (18 files) |
...
New in Cycle 23: `a11y.test.tsx` grows — add textarea + seed-detail title/min fields reachable via `getByLabelText`.

...
- [ ] **Per-category art for the other 7 packs** (Storyset/Pixeltrue/Blush/Humaaans/Open Peeps/unDraw/DrawKit) — one pack per tick; then real downloaded library assets behind the same interface.

...
- [ ] iOS: port the sensor fusion — CoreMotion (activity), AVAudioSession (loudness), **HealthKit heart rate → arousal**, CoreLocation. Mirrors `lib/sensors.ts` + `sensorBonus`. (Mac/Swift.)

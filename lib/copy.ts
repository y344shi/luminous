...
export const copy = {
  ...
  home: {
    ...
    bubblesLead: "也许现在，可以做一点这些：",
    bubblesEmpty: "现在不用做什么，先这样也好。",
    senseWhere: "感知我现在在哪",
    sensing: "正在感知……",
    sensedMoving: "好像在移动，给你一些路上也能做的。",
    sensedHome: "看起来你在家。",
    sensedAway: "看起来你在外面。",
    sensedUnknownHome: "找到你现在的位置了。要把这里设成「家」吗？",
    setHome: "把这里设成家",
    homeSaved: "记住了，以后就能认出你在不在家。",
  ...
  settings: {
    ...
    aiLabel: "AI 模式",
    soundLabel: "完成时的轻响",
    soundOn: "做到一点时，一声很轻的回应",
    soundOff: "安静，不发声",
    nudgeLabel: "轻轻提醒",
    nudgeOn: "在合适的时候，轻轻提醒你一下",
    nudgeOff: "不主动提醒，你来找它就好",
    nudgeHelp: "只在你离开页面、又刚好是合适的时机时提醒；安静时段和每天上限都会遵守。",
    nudgeDenied: "通知被浏览器挡住了，可以在浏览器设置里允许。",
    nudgeUnsupported: "这个环境不支持通知。",
    quietLabel: "安静时段",
